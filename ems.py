...
def delete_employee():
    ...
    if not selected_item:
        ...
        treeview_data()
        clear()
        messagebox.showerror('Success', 'Data is deleted')
...
#GUI
window=CTk()
window.geometry('1200x563+100+100')
window.resizable(False,False)
window.title('Employee Management System')
window.configure(fg_color='#161C30')
logo=CTkImage(Image.open('ems.jpg'),size=(1200,150))
...
role_options=['Web Developer','Cloud Architect','Technical Writer','Network Engineer','Data Scientist','Business Analyst','IT Consultant','UI/UX Designer']
...
salaryEntry=CTkEntry(leftFrame,font=('arial',14,'bold'), width=180)
